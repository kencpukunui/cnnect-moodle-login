 ...
 * Please see the attachment Customized a hook form for user (steps for new_signup_form.php).doc
 */
...
if (!$authplugin = signup_is_enabled()) { // Check if sign-up is enabled in the site. If is enabled, the function will return the authplugin instance.
...
// Start - Change by pukunui, Ticket number LJA-305087
//$mform_signup = $authplugin->signup_form();
$mform_signup = $authplugin->signup_hook_form();
// End - Change by pukunui
